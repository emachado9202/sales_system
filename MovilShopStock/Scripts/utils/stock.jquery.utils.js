        ...
        moreLess: function () {
            return this.each(function () {
                ...
                if (expander.length == 0) {
                    el.append('<a href="#" class="btn-text-expander btn-text-expander--expand text-green"><i class="fa fa fa-angle-double-down pr-2"></i><span>' + Res['Products.Longdesc.More'] + '</span></a>');
                }

                var collapser = el.find('.btn-text-expander--collapse');
                if (collapser.length == 0) {
                    el.append('<a href="#" class="btn-text-expander btn-text-expander--collapse text-green"><i class="fa fa fa-angle-double-up pr-2"></i><span>' + Res['Products.Longdesc.Less'] + '</span></a>');
                }
            });
        }
    }); // $.fn.extend
